 ...
 */
@Singleton
public class ParseResourceRecordSets extends ParseJson<ListPage<ResourceRecordSet>> {

   @Inject
   public ParseResourceRecordSets(Json json) {
      super(json, new TypeLiteral<ListPage<ResourceRecordSet>>() {
      });
   }

   public static class ToPagedIterable extends BaseWithManagedZoneToPagedIterable<ResourceRecordSet, ToPagedIterable> {
      ...
      @Override
      protected Function<Object, IterableWithMarker<ResourceRecordSet>> fetchNextPage(
         ...
         return new Function<Object, IterableWithMarker<ResourceRecordSet>>() {
            ...
            public IterableWithMarker<ResourceRecordSet> apply(Object input) {
               return api.getResourceRecordSetApiForProject(projectName)
